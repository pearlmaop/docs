...
<Tip>
    **DeepSeek's models are open source and can be run locally (e.g. in [Ollama](/oss/integrations/chat/ollama)) or on other inference providers (e.g. , [Together](/oss/integrations/chat/together)) as well.**
</Tip>
