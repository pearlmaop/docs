...
This will help you getting started with IBM watsonx.ai [chat models](/oss/langchain/models). For detailed documentation of all `IBM watsonx.ai` features and configurations head to the [IBM watsonx.ai](https://reference.langchain.com/javascript/langchain-ibm/ChatWatsonx).
...
To access IBM watsonx.ai models you'll need to create a/an IBM watsonx.ai account, get an API key, and install the `@langchain/ibm` integration package.
