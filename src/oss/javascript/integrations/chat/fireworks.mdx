...
This guide will help you getting started with `ChatFireworks` [chat models](/oss/langchain/models). For detailed documentation of all `ChatFireworks` features and configurations head to the [API reference](https://reference.langchain.com/javascript/langchain-fireworks/ChatFireworks).
