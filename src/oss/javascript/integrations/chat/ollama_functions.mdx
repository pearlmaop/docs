...
You can initialize this wrapper the same way you'd initialize a standard `ChatOllama` instance. `OllamaFunctions` is only available from `@langchain/community` (not `@langchain/ollama`):
